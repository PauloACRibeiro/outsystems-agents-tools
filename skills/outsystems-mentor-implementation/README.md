...
- `outsystems-tech-content` is an optional upgrade: employee-only, on the private network endpoint `10.120.88.4:9081`, so it will not work without VPN access. Skip it if either of those does not apply to me.
