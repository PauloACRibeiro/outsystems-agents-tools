...
- Polish gate (per screen, after render): type hierarchy, brand-colour restraint, spacing, realistic content, active state, real headings — `references/execution-gates.md` §2b.
