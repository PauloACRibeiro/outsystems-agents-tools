...
> **Harvested from:** `outsystems-mcp-skills/skills/outsystems-design-to-app/references/screen-guides/reusable-blocks.md` (read-only source, harvested 2026-07-13).
