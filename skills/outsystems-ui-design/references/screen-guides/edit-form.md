...
> **Harvested from:** `outsystems-mcp-skills/skills/outsystems-design-to-app/references/screen-guides/edit-form.md` (read-only source, harvested 2026-07-13).
...
- On save: the screen validates the form, persists via the entity's save action, navigates to detail view on success, and shows error feedback on failure (the build side owns that wiring)
