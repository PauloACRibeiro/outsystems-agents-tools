...
> **Harvested from:** `outsystems-mcp-skills/skills/outsystems-design-to-app/references/screen-guides/design-system.md` (read-only source, harvested 2026-07-13).
...
Style and ExtendedClass are expression properties — their string values must carry an inner quoted literal:

```
Correct — quoted expression string:  Style = "\"card shadow-s margin-bottom-base\""
Wrong — bare string, runtime error:  Style = "card shadow-s margin-bottom-base"
```
