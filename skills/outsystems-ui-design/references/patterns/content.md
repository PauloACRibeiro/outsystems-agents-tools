...
> **Harvested from:** `outsystems-frontend-skills` (OutSystems official, BSD-3-Clause) `ui-frameworks/outsystems-ui/patterns/content.md` (harvested 2026-07-29).
...
```jsonc
{
  ...
  "SourceBlock": "Accordion",
  "Arguments": [
    { "type_": "IArgument", "Parameter": "Accordion.MultipleItems", "Value": "False" }
  ],
  "PlaceholdersContent": [{
    ...
    "Widgets": [
      {
        "type_": "IMobileBlockInstanceWidget",
        "SourceBlock": "AccordionItem",
        "Arguments": [
          { "type_": "IArgument", "Parameter": "AccordionItem.StartsExpanded", "Value": "True" }
        ],
        "PlaceholdersContent": [
          { "type_": "IPlaceholderContentWidget", "Placeholder": "AccordionItem.Title",
            "Widgets": [{ "type_": "ITextWidget", "Text": "Personal details" }] },
          { "type_": "IPlaceholderContentWidget", "Placeholder": "AccordionItem.Content",
            "Widgets": [{ "type_": "ITextWidget", "Text": "…" }] }
        ]
      }
    ]
  }]
