...
> **Harvested from:** `outsystems-frontend-skills` (OutSystems official, BSD-3-Clause) `ui-frameworks/outsystems-ui/patterns/adaptive.md` (harvested 2026-07-29).
...
```jsonc
{
  ...
  "SourceBlock": "Columns3",
  "Arguments": [
    { "type_": "IArgument", "Parameter": "Columns3.GutterSize", "Value": "Entities.GutterSize.Base" },
    { "type_": "IArgument", "Parameter": "Columns3.PhoneBehavior", "Value": "Entities.BreakColumns.All" }
  ],
  "PlaceholdersContent": [
    { "type_": "IPlaceholderContentWidget", "Placeholder": "Columns3.Column1", "Widgets": [/* … */] },
    { "type_": "IPlaceholderContentWidget", "Placeholder": "Columns3.Column2", "Widgets": [/* … */] },
    { "type_": "IPlaceholderContentWidget", "Placeholder": "Columns3.Column3", "Widgets": [/* … */] }
  ]
}
```
...
{
  "type_": "IMobileBlockInstanceWidget",
  "SourceBlock": "DisplayOnDevice",
  "Arguments": [],
  "PlaceholdersContent": [
    { "type_": "IPlaceholderContentWidget", "Placeholder": "DisplayOnDevice.OnDesktop",
      "Widgets": [/* full sidebar layout */] },
    { "type_": "IPlaceholderContentWidget", "Placeholder": "DisplayOnDevice.OnPhone",
      "Widgets": [/* condensed mobile layout */] }
  ]
}
```
...
```jsonc
{
  ...
  "SourceBlock": "Gallery",
  "Arguments": [
    { "type_": "IArgument", "Parameter": "Gallery.RowItemsDesktop", "Value": "4" },
    { "type_": "IArgument", "Parameter": "Gallery.RowItemsTablet",  "Value": "2" },
    { "type_": "IArgument", "Parameter": "Gallery.RowItemsPhone",   "Value": "1" },
    { "type_": "IArgument", "Parameter": "Gallery.ItemsGap",        "Value": "\"base\"" }
  ],
  "PlaceholdersContent": [{
    "type_": "IPlaceholderContentWidget",
    ...
    "Widgets": [{
      ...
      "Widgets": [{
        "type_": "IMobileBlockInstanceWidget",
        "SourceBlock": "CardSectioned",
        "Arguments": [],
        "PlaceholdersContent": [
          { "type_": "IPlaceholderContentWidget", "Placeholder": "CardSectioned.Image",
            "Widgets": [{ "type_": "IImage", "Image": "GetProducts.List.Current.Product.Image" }] },
          { "type_": "IPlaceholderContentWidget", "Placeholder": "CardSectioned.Title",
            "Widgets": [{ "type_": "IExpression", "Value": "GetProducts.List.Current.Product.Name" }] },
          { "type_": "IPlaceholderContentWidget", "Placeholder": "CardSectioned.Content",
            "Widgets": [{ "type_": "IExpression", "Value": "FormatCurrency(GetProducts.List.Current.Product.Price)" }] }
        ]
      }]
    }]
  }]
