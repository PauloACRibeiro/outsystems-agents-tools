...
> **Harvested from:** `outsystems-frontend-skills` (OutSystems official, BSD-3-Clause) `ui-frameworks/outsystems-ui/patterns/numbers.md` (harvested 2026-07-29).
...
```jsonc
{
  ...
  "SourceBlock": "Counter",
  "Arguments": [
    { "type_": "IArgument", "Parameter": "Counter.BackgroundColor", "Value": "Entities.Color.Primary" },
    { "type_": "IArgument", "Parameter": "Counter.Height", "Value": "150" },
    { "type_": "IArgument", "Parameter": "Counter.IsVertical", "Value": "False" },
    { "type_": "IArgument", "Parameter": "Counter.ExtendedClass", "Value": "\"text-neutral-0\"" }
  ],
  "PlaceholdersContent": [{
    "type_": "IPlaceholderContentWidget",
    "Placeholder": "Counter.Content",
    "Widgets": [
      { "type_": "IExpression", "Value": "TotalOrders", "Style": "\"font-size-display\"" },
      { "type_": "ITextWidget", "Text": "Total Orders" },
      { "type_": "IIcon", "Icon": "shopping-cart" }
    ]
  }]
}
```
